      ...
      <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
        ...
        <div className='grid grid-cols-6 gap-6 mt-16'>
          {games.map(game => {
            return (
              <GameBanner 
                key={game.id}  // info unica que identifica cada game
              ...
              <form action="" className='mt-8 flex flex-col gap-4'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor="game" className='font-semibold'>Qual é o game?</label>
                    <Input id='game' placeholder='Selecione o que você deseja jogar'/>
                </div>
                ...
                <div className='flex gap-6'>
                  ...
                  <div className='flex flex-col gap-2 flex-1'>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                      <Input type="time" id='minStart' placeholder='De'/>
                      <Input type="time" id='minEnd' placeholder='Até'/>
                    </div>
                  </div>
                </div>
